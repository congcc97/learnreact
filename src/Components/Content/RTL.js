          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div className="card card-chart">
                ...
                <div className="card-footer">
                  <div className="stats">
                    <i className="material-icons">access_time</i> کمپین دو روز
                    پیش ارسال شد
                  </div>
                </div>
              </div>
                      ...
                      <table className="table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              آنها با استفاده از محتویات ساختگی، صفحه گرافیکی
                              خود را صفحه‌آرایی می‌کنند
                            </td>
                            <td className="td-actions text-right">
                              <button
                                type="button"
                      ...
                      <table className="table">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              بعد از اینکه متن در آن قرار گیرد چگونه به نظر
                              می‌رسد و قلم‌ها و اندازه‌بندی‌ها چگونه در نظر
                              گرفته
                            </td>
                            <td className="td-actions text-right">
                              <button
                          ...
                          <tr>
                            ...
                            <td>
                              اولیه شکل ظاهری و کلی طرح سفارش گرفته شده استفاده
                              می نماید؟
                            </td>
                            <td className="td-actions text-right">
                              <button
                      ...
                      <table className="table">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              گرافیکی نشانگر چگونگی نوع و اندازه فونت و ظاهر متن
                              باشد. معمولا طراحان گرافیک برای صفحه‌آرایی، نخست
                              از متن‌های آزمایشی؟
                            </td>
                            <td className="td-actions text-right">
                              <button
                          ...
                          <tr>
                            ...
                            <td>
                              {" "}
                              از این متن به عنوان عنصری از ترکیب بندی برای پر
                              کردن صفحه و ارایه اولیه شکل ظاهری و کلی طرح سفارش
                              گرفته شده استفاده می نماید، تا از نظر گرافیکی
                              نشانگر چگونگی نوع و اندازه فونت و ظاهر متن باشد.
                              معمولا طراحان گرافیک برای صفحه‌آرایی، نخست از
                              متن‌های آزمایشی ؟
                            </td>
                            <td className="td-actions text-right">
                              <button
                          ...
                          <tr>
                            ...
                            <td>
                              از متن‌های آزمایشی و بی‌معنی استفاده می‌کنند تا
